...
namespace GSpawn_Pro
{
    ...
    public class GSpawn : MonoBehaviour
    {
        ...
        public static string    currentVersion              { get { return "3.3.7"; } }

        [MenuItem("Tools/GSpawn (PRO)/Initialize", false, _menuItemPriorityStart_Initialize)]
        ...
        [MenuItem("Tools/GSpawn (PRO)/Actions/Select-Deselect &R", false, _menuItemPriorityStart_Actions)]
        ...
        [MenuItem("Tools/GSpawn (PRO)/Actions/Transfer Selection &T", false, _menuItemPriorityStart_Actions + 1)]
        ...
        [MenuItem("Tools/GSpawn (PRO)/Actions/Refresh Data Caches", false, _menuItemPriorityStart_Actions + 2)]
        ...
        [MenuItem("Tools/GSpawn (PRO)/Actions/Refresh Prefab Previews", false, _menuItemPriorityStart_Actions + 3)]
        ...
        [MenuItem("Tools/GSpawn (PRO)/Windows/Prefab Library Manager...", false, _menuItemPriorityStart_Prefabs + 1)]
        ...
        [MenuItem("Tools/GSpawn (PRO)/Windows/Prefab Manager...", false, _menuItemPriorityStart_Prefabs + 2)]
        ...
        [MenuItem("Tools/GSpawn (PRO)/Windows/Random Prefabs...", false, _menuItemPriorityStart_Prefabs + 3)]
        ...
        [MenuItem("Tools/GSpawn (PRO)/Windows/Integer Range Prefabs...", false, _menuItemPriorityStart_Prefabs + 4)]
        ...
        [MenuItem("Tools/GSpawn (PRO)/Windows/Scatter Brush Prefabs...", false, _menuItemPriorityStart_Prefabs + 5)]
        ...
        [MenuItem("Tools/GSpawn (PRO)/Windows/Tile Rules...", false, _menuItemPriorityStart_Prefabs + 6)]
        ...
        [MenuItem("Tools/GSpawn (PRO)/Windows/Modular Wall Prefabs...", false, _menuItemPriorityStart_Prefabs + 7)]
        ...
        [MenuItem("Tools/GSpawn (PRO)/Windows/Curve Prefabs...", false, _menuItemPriorityStart_Prefabs + 8)]
        ...
        [MenuItem("Tools/GSpawn (PRO)/Windows/Integer Patterns...", false, _menuItemPriorityStart_Misc + 2)]
        ...
        [MenuItem("Tools/GSpawn (PRO)/Windows/Object Layers...", false, _menuItemPriorityStart_Misc)]
        ...
        [MenuItem("Tools/GSpawn (PRO)/Windows/Object Groups...", false, _menuItemPriorityStart_Misc + 1)]
        ...
        [MenuItem("Tools/GSpawn (PRO)/Windows/Grid Settings...", false, _menuItemPriorityStart_Misc + 2)]
        ...
        [MenuItem("Tools/GSpawn (PRO)/Windows/Shortcuts...", false, _menuItemPriorityStart_Misc + 3)]
        ...
        [MenuItem("Tools/GSpawn (PRO)/Windows/Mesh Combine...", false, _menuItemPriorityStart_Misc + 4)]
        ...
        [MenuItem("Tools/GSpawn (PRO)/Windows/Export Data...", false, _menuItemPriorityStart_Data)]
